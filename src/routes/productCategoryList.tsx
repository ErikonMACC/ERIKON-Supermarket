import('tailwindcss')
import { getProductsByCategory, getCategories } from '../api/get-products'
...
function ProductCategoryList() {
    ...
    const { data: productsData, isLoading: productsDataLoading } = useQuery({
        queryKey: ['products'],
        queryFn: () => getProductsByCategory(category || "beauty")
    })
    ...
    return (
        <>
            ...
            <p className="title container mx-auto">{category} Items</p>
